...
const Profile = () => {
  ...
  const reverseGeocoding = async (latitude, longitude) => {
    var response = await fetch(
      `https://api.mapbox.com/search/geocode/v6/reverse?longitude=${longitude}&latitude=${latitude}&limit=1&access_token=pk.eyJ1IjoiZGhpcmFqa2hhbGkiLCJhIjoiY20zaXR4ejRnMDN0ZjJpczRxNnFmeTF5YiJ9.u-36U__G_L641Ad2K3sI1w`,
    );
          ...
          <section className="container py-10 md:py-11 lg:py-12">
            <div className="grid gap-8">
              <div className="col-span-2 lg:col-span-1">
                ...
                <div className="grid sm:grid-cols-2 gap-6 mt-4 projects">
